...
export default function ContentProfileTag({ profileTags, setProfileTags, pubkyUser, user }: ProfileTagProps) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6">
      <InputTag profileTags={profileTags} setProfileTags={setProfileTags} pubkyUser={pubkyUser} user={user} />
      <div className="justify-start items-start gap-2 flex flex-col overflow-y-auto min-w-[200px] max-h-[300px] scrollbar-thin scrollbar-webkit">
        ...
        <Tags profileTags={profileTags} setProfileTags={setProfileTags} pubkyUser={pubkyUser} user={user} />
      </div>
    </div>
  );
}
