...
export default function Root({ show, setShow, title, children, homeIndicatorCSS, ...rest }: RootBottomSheetProps) {
  ...
  const baseCSS =
    'max-h-[90vh] overflow-y-auto min-h-[250px] relative w-full bg-[#05050a] rounded-t-3xl mx-1 px-6 border border-white border-dashed border-opacity-30 z-50 transition-transform duration-300 touch-action-none';
