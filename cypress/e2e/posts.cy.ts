...
describe('posts', () => {
  ...
  it('signout when 401 response from homesever when creating new post', () => {
  ...
  it('signout when 401 response from homeserver when creating new article', () => {
    ...
    // Check that session expired modal is displayed (be specific to avoid finding the article modal)
    cy.contains('#modal-root', 'Session expired').should('be.visible');
