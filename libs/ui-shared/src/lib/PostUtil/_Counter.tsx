...
export const Counter = ({ id, children, textCSS, ...rest }: CounterProps) => {
  const baseCSS = `leading-none w-8 h-8 px-3 py-1.5 bg-black rounded-[32px] border border-white border-opacity-30 flex-col justify-center items-center gap-2 inline-flex`;
