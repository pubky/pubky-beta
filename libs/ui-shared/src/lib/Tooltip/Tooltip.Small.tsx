...
export const Small = ({ children, ...rest }: SmallProps) => {
  ...
  return (
    <div {...rest} className={twMerge(baseCSS, rest.className)}>
      {children}
      <div className="absolute -bottom-[15px] left-1/2 transform -translate-x-1/2 w-0 h-0 border-8 border-solid border-[#1b1820] border-b-transparent border-l-transparent border-r-transparent" />
    </div>
  );
};
