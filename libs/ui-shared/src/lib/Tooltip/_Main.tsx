...
export const Main = ({ children, ...rest }: MainProps) => {
  ...
  const baseCSS =
    'w-full absolute left-1/2 transform -translate-x-1/2 bg-gradient-to-br from-black to-[#0e0e18] border border-white border-opacity-30 text-white px-8 py-6 rounded-[20px] shadow-md z-50';
