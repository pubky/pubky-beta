...
export const Pencil = ({ size = '48', color = 'white' }: IconProps) => (
  ...
  >
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M6.5348 29.0348C7.12059 28.449 8.07033 28.449 8.65612 29.0348L18.9649 39.3435C19.5507 39.9293 19.5507 40.8791 18.9649 41.4649C18.3791 42.0507 17.4293 42.0507 16.8436 41.4649L6.5348 31.1561C5.94901 30.5703 5.94901 29.6206 6.5348 29.0348Z"
      fill={color}
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M29.3787 6.00002C29.9413 5.43741 30.7044 5.12134 31.5 5.12134C32.2956 5.12134 33.0587 5.43741 33.6213 6.00002L32.6185 7.00282L33.6213 6.00002L42 14.3787C42.5626 14.9413 42.8787 15.7044 42.8787 16.5C42.8787 17.2957 42.5626 18.0587 42 18.6213L19.5 41.1213C19.2214 41.3999 18.8907 41.6209 18.5267 41.7717C18.1628 41.9224 17.7726 42 17.3787 42H9C8.20435 42 7.44129 41.6839 6.87868 41.1213C6.31607 40.5587 6 39.7957 6 39V30.6213C6 30.2274 6.0776 29.8373 6.22836 29.4733C6.37912 29.1093 6.6001 28.7786 6.87868 28.5L29.3787 6.00002ZM39.8787 16.5L31.5 8.12134L9 30.6213L7.93934 29.5607L9 30.6213L9 39L17.3787 39L39.8787 16.5Z"
      fill={color}
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M24.4393 10.9393C25.0251 10.3536 25.9749 10.3536 26.5607 10.9393L37.0607 21.4393C37.6464 22.0251 37.6464 22.9749 37.0607 23.5607C36.4749 24.1464 35.5251 24.1464 34.9393 23.5607L24.4393 13.0607C23.8536 12.4749 23.8536 11.5251 24.4393 10.9393Z"
      fill={color}
    />
  </svg>
);
...
export const Stack = ({ size = '24', color = 'white' }: IconProps) => (
  ...
  >
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M2.35217 16.1221C2.56088 15.7643 3.02011 15.6435 3.3779 15.8522L12 20.8817L20.6221 15.8522C20.9799 15.6435 21.4391 15.7643 21.6478 16.1221C21.8565 16.4799 21.7357 16.9391 21.3779 17.1478L12.3779 22.3978C12.1444 22.5341 11.8556 22.5341 11.6221 22.3978L2.6221 17.1478C2.26431 16.9391 2.14346 16.4799 2.35217 16.1221Z"
      fill={color}
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M2.35217 11.6221C2.56088 11.2643 3.02011 11.1435 3.3779 11.3522L12 16.3817L20.6221 11.3522C20.9799 11.1435 21.4391 11.2643 21.6478 11.6221C21.8565 11.9799 21.7357 12.4391 21.3779 12.6478L12.3779 17.8978C12.1444 18.0341 11.8556 18.0341 11.6221 17.8978L2.6221 12.6478C2.26431 12.4391 2.14346 11.9799 2.35217 11.6221Z"
      fill={color}
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M11.6221 1.60217C11.8556 1.46594 12.1444 1.46594 12.3779 1.60217L21.3779 6.85217C21.6083 6.98657 21.75 7.23325 21.75 7.5C21.75 7.76675 21.6083 8.01343 21.3779 8.14783L12.3779 13.3978C12.1444 13.5341 11.8556 13.5341 11.6221 13.3978L2.6221 8.14783C2.39168 8.01343 2.25 7.76675 2.25 7.5C2.25 7.23325 2.39168 6.98657 2.6221 6.85217L11.6221 1.60217ZM4.48848 7.5L12 11.8817L19.5115 7.5L12 3.11828L4.48848 7.5Z"
      fill={color}
    />
  </svg>
);
