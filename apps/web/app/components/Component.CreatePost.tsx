...
export default function CreatePost() {
  ...
  return (
    <>
      <div className="fixed bottom-5 right-5 max-w-[50%] max-h-[50%] sm:bottom-10 sm:right-10">
      ...
      >
        ...
        <Modal.Content className="flex flex-col gap-2 lg:grid lg:grid-cols-3 lg:gap-6">
